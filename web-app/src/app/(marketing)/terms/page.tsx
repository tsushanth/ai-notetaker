    ...
    <div className="py-16">
      <div className="max-w-[900px] mx-auto px-6">
        ...
        <section className="mb-10">
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed mb-3">
            Scribe AI uses cloud-based AI services to provide transcription, summarization, quiz generation,
            flashcard creation, mind maps, infographics, and podcast generation. By using these features, you
            acknowledge and consent to your content being processed by the third-party services identified in
            our <a href="/privacy" className="text-[var(--accent-purple-light)] hover:underline">Privacy Policy</a>.
            These services include OpenAI (GPT-4, Whisper, TTS) and Supabase.
          </p>
          <p className="text-[var(--text-secondary)] leading-relaxed">
            You may revoke this consent at any time in the app&apos;s Settings, which will prevent the app from
            sending your data to AI services. Without consent, AI-powered features will be unavailable.
          </p>
        </section>
